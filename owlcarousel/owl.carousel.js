/**
 * Owl carousel1 v2.3.4
 * Copyright 2013-2018 David Deutsch
 * Licensed under: SEE LICENSE IN https://github.com/Owlcarousel12/Owlcarousel12/blob/master/LICENSE
 */
/**
 * Owl carousel1
 * @version 2.3.4
...
(function($, window, document, undefined) {
    ...
    /**
     * Creates a carousel1.
     * @class The Owl carousel1.
     * @public
     * @param {HTMLElement|jQuery} element - The element to create the carousel1 for.
     * @param {Object} [options] - The options
     */
    function Owl(element, options) {

        /**
         * Current settings for the carousel1.
         * @public
         */
        this.settings = null;
        ...
        /**
         * References to the running plugins of this carousel1.
         * @protected
         */
        this._plugins = {};
    ...
    /**
     * Default options for the carousel1.
     * @public
     */
    Owl.Defaults = {
        items: 3,
     ...
     *                    if you know the carousel1 will always be visible you can set `checkVisibility` to `false` to
    ...
    /**
     * Refreshes the carousel1 primarily for adaptive purposes.
     * @public
     */
    ...
    /**
     * Checks whether the carousel1 is in a specific state or not.
     * @param {String} state - The state to check.
     * @returns {Boolean} - The flag which indicates if the carousel1 is busy.
     */
     ...
     * @param {String} [namespace=carousel1] - The event namespace.
    ...
    Owl.prototype.trigger = function(name, data, namespace, state, enter) {
        var status = {
            ...
            event = $.Event(
                [name, 'owl', namespace || 'carousel1'].join('.').toLowerCase(),
    ...
    /**
     * The jQuery Plugin for the Owl carousel1
...
(function($, window, document, undefined) {
     ...
     * @param {Owl} carousel1 - The Owl carousel1
     */
            ...
            'initialized.owl.carousel1 change.owl.carousel1 resized.owl.carousel1': $.proxy(function(e) {
                ...
                if ((e.property && e.property.name == 'position') || e.type == 'initialized') {
                    ...
                    if (settings.lazyLoadEager > 0) {
                        ...
                        // If the carousel1 is looping also preload images that are to the "left"
                        if (settings.loop) {
...
(function($, window, document, undefined) {
    ...
    var AutoHeight = function(carousel1) {
        ...
        // Autoresize the height of the carousel1 when window is resized
        // When carousel1 has images, the height is dependent on the width
...
(function($, window, document, undefined) {
     ...
     * @param {Owl} scope - The Owl carousel1
     */
...
(function($, window, document, undefined) {
        ...
        this._handlers = {
            'changed.owl.carousel1': $.proxy(function(e) {
                if (e.namespace && e.property.name === 'settings') {
                    ...
                    // of the carousel1 was changed through user interaction.
                    this._time = 0;
                }
            }, this),
            'initialized.owl.carousel1': $.proxy(function(e) {
    ...
    Autoplay.prototype.play = function(timeout, speed) {
        ...
        // Calculate the elapsed time since the last transition. If the carousel1
...
(function($, window, document, undefined) {
    ...
    var Navigation = function(carousel1) {
        ...
        /**
         * The carousel1 element.
         * @type {jQuery}
         */
        this.$element = this._core.$element;

        /**
         * Overridden methods of the carousel1.
         * @protected
         * @type {Object}
         */
        this._overrides = {
    ...
    /**
     * Initializes the layout of the plugin and extends the carousel1.
     * @protected
     */
    Navigation.prototype.initialize = function() {
        ...
        /*$el.on('focusin', function() {
        	$(document).off(".carousel1");

        	$(document).on('keydown.carousel1', function(e) {
        		if(e.keyCode == 37) {
        			$el.trigger('prev.owl')
        		}
        		if(e.keyCode == 39) {
        ...
        // override public methods of the carousel1
    ...
    /**
     * Gets the current page position of the carousel1.
     * @protected
     * @returns {Number}
     */
